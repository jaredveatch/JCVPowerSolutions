...
urlpatterns = [
    ...
    path(
        "leads/",
        customer_views.leads,
        name="leads"
    ),

    path(
        "leads/<int:lead_id>/",
        customer_views.lead_detail,
        name="lead_detail"
    ),

    path(
        "leads/<int:lead_id>/convert/",
        customer_views.convert_lead,
        name="convert_lead"
    ),

    path(
        "leads/<int:lead_id>/delete/",
        customer_views.delete_lead,
        name="delete_lead"
    ),
    ...
    path(
        "customers/<int:customer_id>/create-job/",
    ...
    path(
        ...
        job_views.delete_job,
        name="delete_job"
    ),

    path(
        "jobs/<int:job_id>/update-status/",
        job_views.update_job_status,
        name="update_job_status"
    ),

    path(
        "jobs/<int:job_id>/add-note/",
        job_views.add_job_note,
        name="add_job_note"
    ),

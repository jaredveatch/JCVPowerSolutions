...
urlpatterns = [
    ...
    # AI COMMAND CENTER
    path("ai/", views_ai.ai_dashboard, name="ai_dashboard"),
    path("ai/job/<int:job_id>/generate-scope/", views_ai.ai_generate_job_scope, name="ai_generate_job_scope"),
    path("ai/template/<int:template_id>/suggest-materials/", views_ai.ai_generate_template_materials, name="ai_generate_template_materials"),
    path("ai/template/<int:template_id>/review-pricing/", views_ai.ai_review_template_pricing, name="ai_review_template_pricing"),
    path("ai/website-review/", views_ai.ai_generate_website_review, name="ai_generate_website_review"),
    path("ai/business-review/", views_ai.ai_generate_business_review, name="ai_generate_business_review"),
